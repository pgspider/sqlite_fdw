...
sed -i 's/REGRESS =.*/REGRESS = extra\/sqlite_fdw_post types\/bitstring types\/bool types\/float4 types\/float8 types\/int4 types\/int8 types\/macaddr6 types\/macaddr8 types\/numeric types\/out_of_range types\/timestamp types\/uuid extra\/join extra\/limit extra\/aggregates extra\/prepare extra\/select_having extra\/select extra\/insert extra\/update extra\/encodings sqlite_fdw type aggregate selectfunc /' Makefile
