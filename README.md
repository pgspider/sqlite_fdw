...
1. Install packages for PostgreSQL build from source code.
2. Get, compile and check PostgreSQL source trees for selected version
3. Move source code to `contrib/sqlite_fdw` directoriy in PostgreSQL source code
4. Do `./test.sh` and modify your code untill success.
