...
CREATE TABLE "type_JSON" (i int, j json, ot varchar(8), oi int);
CREATE TABLE "type_JSONB" (i int, j jsonb, ot varchar(8), oi int);
CREATE TABLE "JSON_query" (i int, q char(64));
